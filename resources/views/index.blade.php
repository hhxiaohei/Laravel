                    ...
                    <div class="pro_bor">
                        <ul class="clearfix pro_list_box">
                            ...
                            <li class="w3">
                                ...
                                <p class="fc_6 airal fs_18">{{$v->money/100}}</p>
                            </li>
                            <li class="w4">
                                <span class="b_jingdu b_jd{{100*$v->recive/$v->money}}">{{sprintf('%.1f',100*$v->recive/$v->money)}}%</span>
                            </li>
                            <li class="w5">
                                    <a class="btn btnSize_1 btn_orange" href="{{url('pro',['pid'=>$v->pid])}}">立即投标</a>
                            </li>
                        </ul>
                    </div>
                    @endforeach
